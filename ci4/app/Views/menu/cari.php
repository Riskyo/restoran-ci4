        ...
        <table class="table">
            ...
            <?php foreach ($menu as $key => $value) : ?>
                <tr>
                    ...
                    <td> <a href="<?= base_url() ?>/admin/menu/delete/<?= $value['idkategori'] ?>"> <img src="<?= base_url('/icon/can.svg') ?>"> </a>
                        <a href="<?= base_url() ?>/admin/menu/find/<?= $value['idkategori'] ?>"> <img src="<?= base_url('/icon/pen.svg') ?>"> </a> </td>
                </tr>
            <?php endforeach; ?>
        </table>
